...
ROS_OB <- post_values(m_controlled_mean_ros_OB, "none")
DNA_OB <- post_values(m_controlled_mean_dnadamage_OB, "none")
LP_OB <- post_values(m_controlled_mean_peroxidation_OB, "none")
DET_OB <- post_values(m_controlled_t_D_Chemical, "none")
#
# B) Optic tecta/Visual stimulus
MD_OT <- post_values(m_controlled_mean_mitodensity_OT, "none")
MP_OT <- post_values(m_controlled_mean_potential_OT, "none")
ROS_OT <- post_values(m_controlled_mean_ros_OT, "none")
DNA_OT <- post_values(m_controlled_mean_dnadamage_OT, "sex")
LP_OT <- post_values(m_controlled_mean_peroxidation_OT, "none")
DET_OT <- post_values(m_controlled_t_D_Visual, "none")
#
#
#
#
