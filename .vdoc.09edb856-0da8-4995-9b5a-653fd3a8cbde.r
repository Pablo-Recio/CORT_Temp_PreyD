...
# Print final plot
ggsave(here("./output/figures/text/plot_OB_con.png"), plot = plot_OB_con, width = 21, height = 14, units = "cm", dpi = 600, bg = "white")
knitr::include_graphics("./output/figures/text/plot_OB_con.png")
#
#
#
#
