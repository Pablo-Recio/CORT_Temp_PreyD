...
#
fig_OB_con_top <- plot_grid(plot_potential_OB_con, plot_ROS_OB_con
                    ncol = 2)
fig_OB_con_bottom <- plot_grid(plot_DNA_OB_con, plot_LP_OB_con,
                    ncol = 2)
fig_OB_con <- plot_grid(fig_OB_con_top, fig_OB_con_bottom, NULL
...
# 
# Final composition: Merge everything, adding images and legend
final_plot_energy <- ggdraw(fig_OB_con +
