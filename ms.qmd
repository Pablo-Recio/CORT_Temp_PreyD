...
To measure prey detection, we presented lizards with chemical and visual stimuli from familiar and unfamiliar prey, then recording and analysing their behaviour towards each stimulus (@fig-Methods C). We used living crickets (_A. domestica_) as the familiar prey and living mealworm larvae (_Tenebrio molitor_) as the unfamiliar prey. We tested the effects of familiarity with the pretty items because previous experience may influence stimuli perception through habituation or sensitisation [@burger_effects_1990; @burger_effects_1991; @desfilis2003stimulus].  
