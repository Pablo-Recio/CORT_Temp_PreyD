...
## Discussion
We examined the impact of prenatal temperature and CORT on visual and chemical perception and determined whether metabolic function underpinned any perceptual differences, as previously shown in mammals [@hara_presynaptic_2014; @chaudhari2022early]. Overall, metabolic processes appeared largely resilient to prenatal environment. However, early-life conditions produced region- and context-dependent effects on oxidative damage and prey detection. We observed interactive effects of prenatal CORT and incubation temperature on lipid proxidation in both regions, while the interaction affected DNA damage only in the optic tecta. Behaviourally, CORT enhanced detection of chemical-but not visual-prey stimuli. Yet, we found no evidence that metabolic explained behavioural variation. Below, we discuss these findings in the context of mitochondrial metabolic function, oxidative stress, and perception.    

#### Metabolic processes in multiple brain regions are robust to early life conditions
Contrary to our predictions, we found no significant effects of early environmental conditions on mitochondrial density, metabolic capacity, or ROS production in either of the brain regions studied. These results were consistent when the effect on the average mitochondrion was analysed (i.e. when metabolic capacity and ROS production were divided by mitochondrial density). Our findings suggest that metabolic function in _L. delicata_'s brain is relatively resilient to early-life conditions. However, evidence from other species indicates that the effects of CORT and temperature can be region-specific: incubation temperature alters metabolic capacity in some, but not all, brain nuclei of leopard geckos (_Eublepharis macularius_) [@coomber_independent_1997], and prenatal stress reduces mitochondrial efficiency in select nuclei of rats (_Rattus norvegicus_) [@gong_chronic_2011]. Thus, while our results point to robustness in the regions studied, other brain areas in _L. delicata_ may be more sensitive to prenatal CORT and temperature.              
