...
Contrary to our predictions, we found no significant effects of early environmental conditions on mitochondrial density, metabolic capacity, or ROS production in the optic tecta or the olfactory bulbs. These results were consistent when metabolic capacity and ROS production were standardised by mitochondrial density. Our findings suggest that metabolic function in the brain of _L. delicata_ is relatively resilient to early-life conditions. While we did not observe effects in the optic tecta and olfactory bulbs, evidence from other species indicates that the effects of prenatal CORT and temperature can be region-specific. For example, incubation temperature alters metabolic capacity in some, but not all, brain nuclei of leopard geckos (_Eublepharis macularius_) [@coomber_independent_1997], and prenatal stress reduces mitochondrial efficiency in select nuclei of rats (_Rattus norvegicus_) [@gong_chronic_2011]. Thus, while our results point to robustness in the regions studied, other brain areas in _L. delicata_ may be more sensitive to prenatal CORT and temperature.              
