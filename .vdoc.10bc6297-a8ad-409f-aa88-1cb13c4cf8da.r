...
# Names posteriors:
region <- c("OB", "OT")
names_OB_cont <- c("m_controlled_mean_potential_OB", "m_controlled_mean_ros_OB", "m_controlled_mean_dnadamage_OB", "m_controlled_mean_peroxidation_OB", "m_controlled_t_D_Chemical")
names_OT_cont <- c("m_controlled_mean_potential_OT", "m_controlled_mean_ros_OT", "m_controlled_mean_dnadamage_OT", "m_controlled_mean_peroxidation_OT", "m_controlled_t_D_Visual")
#
# Organising the results
for (r in region) {
  ...
  for (pos in model_select) {
    ...
    # Append to the appropriate data frame
    if (r == "OB") {
      post_OB_cont <- bind_rows(post_OB, post_result)
    } else {
      post_OT_cont <- bind_rows(post_OT, post_result)
    }
  }
}
#
